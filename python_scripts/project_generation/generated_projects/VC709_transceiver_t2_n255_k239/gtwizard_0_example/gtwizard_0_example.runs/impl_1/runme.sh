...
HD_PWD='/home/freakuency/Vivado/April/VC709_transceiver_k113_n127_t2/gtwizard_0_example/gtwizard_0_example.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gtwizard_0_exdes.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gtwizard_0_exdes.tcl -notrace
