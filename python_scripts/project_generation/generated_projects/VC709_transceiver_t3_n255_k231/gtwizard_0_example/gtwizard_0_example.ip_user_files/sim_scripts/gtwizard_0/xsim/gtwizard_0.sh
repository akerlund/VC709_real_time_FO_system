...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot gtwizard_0 xil_defaultlib.gtwizard_0 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim gtwizard_0 -key {Behavioral:sim_1:Functional:gtwizard_0} -tclbatch cmd.tcl -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/opt/Xilinx/Vivado2017/Vivado/2017.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
